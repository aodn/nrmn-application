...
(
    ...
    l5                       character varying(255),
    l95                      character varying(255),
    lmax                     character varying(255),
    ...
    inverts                  character varying(255),
    is_invert_sizing         character varying(255),
    latitude                character varying(255),
    longitude                character varying(255),
    m2_invert_sizing_species character varying(255),
    measure_value            json,
...
ALTER TABLE ONLY nrmn.staged_survey
    ALTER COLUMN id SET DEFAULT nextval('nrmn.staged_survey_id_seq'::regclass);
...
--
-- Name: sec_user_roles sec_user_sec_role_pkey; Type: CONSTRAINT; Schema: nrmn; Owner: -
--

ALTER TABLE ONLY nrmn.sec_user_roles
...
--
-- Name: sec_user_roles fk_role_user_sec; Type: FK CONSTRAINT; Schema: nrmn; Owner: -
--
...
--
-- Name: sec_user_roles fk_user_sec_role; Type: FK CONSTRAINT; Schema: nrmn; Owner: -
--
