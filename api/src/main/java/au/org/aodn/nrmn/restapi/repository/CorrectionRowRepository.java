...
public interface CorrectionRowRepository
    ...
    @Query(value = "select c.observation_id, c.survey_id, " +
            ...
            "cast(jsonb_object_agg(c.measure_id, c.measure_sum) as text) as measurementJson " +
            "from ( " +
            "select " +
            ...
            "o.measure_id, sum(o.measure_value) as \"measure_sum\" " +
            ...
            ") c " +
            "group by c.observation_id, c.survey_id, c.diver_id, c.initials, " +
            "c.site_code, c.depth, c.survey_date, c.survey_time, c.visibility, " +
            "c.direction, " +
            "c.latitude, c.longitude, " +
            "c.observable_item_id, c.observable_item_name, c.letter_code, " +
