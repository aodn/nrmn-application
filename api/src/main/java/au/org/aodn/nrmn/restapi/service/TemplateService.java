...
public class TemplateService {
    ...
    private static final CSVFormat SITES_FORMAT = CSVFormat.DEFAULT.withHeader("SITE", "Site Name", "Latitude",
            "Longitude", "Region");
    private static final CSVFormat SPECIES_FORMAT = CSVFormat.DEFAULT.withHeader("code", "Species_name", "Common Name",
            "L5", "L95", "LMax");
    private static final CSVFormat M3_FORMAT = CSVFormat.DEFAULT.withHeader("Letter_code", "Species_name",
            "Common_name");
    ...
    public void writeSpeciesCsv(Writer writer, Collection<SpeciesWithAttributesCsvRow> species) throws IOException {
