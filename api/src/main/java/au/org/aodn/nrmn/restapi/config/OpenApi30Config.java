...
public class OpenApi30Config {
    ...
    public OpenApi30Config(
        @Value("${app.api.module-name}") String moduleName,
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
            /* configure security scheme as JWT/bearerAuth to enable authorisation using swagger authorize button */
            ...
            /* configure api title and version - displayed in swagger */
    ...
    OpenApiCustomiser OpenApiTagsCustomiser() {
        return openApi -> openApi.getPaths()
            ...
            .flatMap(pathItem -> pathItem.readOperations()
                .stream())
            .forEach(operation -> {
                String tagName = operation.getTags()
                    .get(0);
