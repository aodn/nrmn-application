...
const JobList = () => {
    ...
    const colunmDef = [
        ...
        },
        {
            ...
            cellRendererFramework: function detelete(params) {
                return ((<IconButton color="error" onClick={() => setPopup(params.data.id, params.rowIndex)}>
    ...
    return (<Box>
        ...
        >
            <DialogTitle color="primary" id="Confirmation-upload">{'Confirmation'}</DialogTitle>
            <DialogContent>
                <DialogContentText>
                    Are you sure you want to delete the job {deletePopup.jobId}
                </DialogContentText>
            </DialogContent>
            <DialogActions>
