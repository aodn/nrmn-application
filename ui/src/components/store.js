...
import getMatchingWorms from './data-entities/middleware/worms';
...
function* rootSaga() {
  yield all([importMiddleware(), FileMiddleware(), LoginWatcher(), getEntitiesWatcher(), jobWatcher(), getMatchingWorms()]);
}
