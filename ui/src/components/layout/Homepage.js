  ...
  return (
    <>
      <ThemeProvider theme={theme}>
        <Grid container direction="row" justify="center" alignItems="center" className={classes.spacer}>
          <Grid item>
            <Grid container alignItems="flex-start" justify="space-around" direction="column" className={classes.spacer}>
              <Grid item>
              ...
              <Grid item>
                <Box className={classes.boxes}>
                  ...
                  <ul>
                    <li>
                      Collate, clean, store and make rapidly available, all data obtained during shallow reef surveys conducted by the
                  ...
                  <p>
                    <b>Australia’s Integrated Marine Observing System (IMOS)</b> is enabled by the National Collaborative Research
                    Infrastructure Strategy (NCRIS). It is operated by a consortium of institutions as an unincorporated joint venture, with
                    the
                    <a title="UTAS home page" href="http://www.utas.edu.au/">
                      {' '}
              ...
              <Grid item>
                <Box className={classes.boxes}>
                  <Typography variant={'h4'}>
                    ...
                    <a title="AODN Portal" rel="noreferrer" target="_blank" href="https://portal.aodn.org.au/">
                      AODN Portal
                    </a>
                    .
                  </Typography>
                  ...
                  <p>
                    <a title="Email us for help in using this site" href="mailto:info@aodn.org.au?subject=Portal enquiry - ">
                      Contact
                    </a>
                    <b> | </b>
                    <a
                      title="Data usage acknowledgement"
                      href="https://help.aodn.org.au/user-guide-introduction/aodn-portal/data-use-acknowledgement"
                    >
                      Acknowledgement
                    </a>
                    <b> | </b>
                    <a title="Disclaimer information" href="https://help.aodn.org.au/user-guide-introduction/aodn-portal/disclaimer">
                      Disclaimer
                    </a>
                    <b> | </b>

                    <a title="Australian Ocean Data Network" rel="noreferrer" target="_blank" href="http://imos.org.au/aodn.html">
                      AODN
                    </a>
                    <b> | </b>
                    <a title="Integrated Marine Observing System" href="http://www.imos.org.au/">
                      IMOS
                    </a>
                  </p>
                </Box>
        ...
        <Box className={classes.supporters}>
          <Grid container direction="row" justify="center" alignItems="center">
            <Grid item>
              ...
              <Box display="flex" flexWrap="wrap" css={{maxWidth: maxContentWidth}} className={classes.spacer}>
                {logoData.map((tile) => (
                  <Box pr={2} pb={2} mr={1} width={150} key={tile.title + '-logo'}>
                    <a href={tile.href}>
                      <img width={140} src={process.env.PUBLIC_URL + tile.img} alt={tile.title} />
                    </a>
                  </Box>
                ))}
              </Box>
